...
//
    ...
    public function editCVAction(Request $request)
    {
        ...
        if ($request->isMethod('GET')) {
            ...
            $dmd_cv = $this->getRepositoryClass('AdminBundle:epizy_demandeur_cvs')->find($id_cv);
            $id_demandeur = $dmd_cv->getIdDemandeur();
            $dmd_emploi = $this->getRepositoryClass('AdminBundle:epizy_demandeur_emplois')->find($id_demandeur);
            $id_cv = $dmd_cv->getId();
            $dmd_formation = $this->getRepositoryClass('AdminBundle:epizy_demandeur_formations')->findBy(['id_cvs' => $id_cv]);
            $dmd_experience = $this->getRepositoryClass('AdminBundle:epizy_demandeur_experience')->findBy(['id_cv' => $id_cv]);
        }

        //$form_emplois = $this->createForm(epizy_demandeur_emploisType::class, $dmd_emploi);
        //$form_cvs = $this->createForm(epizy_demandeur_cvsType::class, $dmd_cv );
